# Retrieval Model Profiles

## Purpose

Define crate-owned formatting conventions for retrieval embeddings across different model families (Gemma, Qwen3), supporting query/document role differentiation and optional instruction injection.
