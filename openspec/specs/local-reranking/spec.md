...
Provide local reranking inference capabilities via llama.cpp when the `local` feature is enabled, with support for instruction-aware Qwen3 reranker models.
